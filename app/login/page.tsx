...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative bg-[#050505] overflow-hidden px-4">
      ...
      <div className="absolute top-[-200px] left-[-100px] w-[600px] h-[600px] bg-blue-600/10 rounded-full blur-[140px] animate-pulse" />
      <div className="absolute bottom-[-150px] right-[-100px] w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[140px] animate-pulse" />
      ...
      <footer className="fixed bottom-0 left-0 right-0 h-12 border-t border-white/5 px-12 flex items-center justify-between text-[10px] uppercase tracking-[0.2em] text-slate-600 z-20 backdrop-blur-sm">
        <div>© 2026 Nexus Architecture Group</div>
        <div className="flex gap-6">
          <span>Privacy Protocol</span>
          <span>Security Vitals</span>
        </div>
      </footer>
    </main>
  );
